 ...
 */
class get_Security_RequestMatcher_7csZn50Service extends App_KernelDevDebugContainer
{
    /**
     * Gets the private '.security.request_matcher.7csZn50' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['.security.request_matcher.7csZn50'] = new \Symfony\Component\HttpFoundation\ChainRequestMatcher([($container->privates['.security.request_matcher._vI4fLm'] ??= new \Symfony\Component\HttpFoundation\RequestMatcher\PathRequestMatcher('^/api/auth/token'))]);
    }
}
